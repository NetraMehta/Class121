...
# Capturing backround for 60 frames
...
while (cap.isOpened()):
    ...
    #Flipping the image for cansistency
    ...
    #Generating the mask to detect red colour
    ...
    #Open and expande the image where there is mask 1 (colour)
    ...
    #Keeping only the part of the images without he red colour

    res_1 = cv2.bitwise_and(img, img, mask = mask_2)

    #Keeping only the parts of the images with the red colour
